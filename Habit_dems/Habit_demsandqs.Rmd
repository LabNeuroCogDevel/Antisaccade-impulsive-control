...
Habit2_uppsp <- read.csv("/Volumes/Hera/Victoria/Habit_dems/AdolescentStriatalNe-Uppsp_DATA_2024-11-15.csv")
...
SPA_uppsp <- read.csv("/Volumes/Hera/Victoria/Habit_dems/SPAR01RefinementOfBr-Uppsp_DATA_2024-11-15.csv")
#exclude columns we don't want
...
alpha_uppsp <- subset(uppsp, select=-c(lunaid, vdate, upps_negurg, upps_pre, upps_pers, upps_ss, upps_pu, upps_tot))

cronbachs_alpha(alpha_uppsp)
```
